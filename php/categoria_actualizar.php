<?php
    ...
    if($check_categoria->rowCount()<=0){
    	echo '
            <div class="notification is-danger is-light">
                ...
                La categorÌa no existe en el sistema
            </div>
        ';
        exit();
    }else{
    ...
    if(verificar_datos("[a-zA-Z0-9·ÈÌÛ˙¡…Õ”⁄Ò— ]{4,50}",$nombre)){
        echo '
            <div class="notification is-danger is-light">
                <strong>°Ocurrio un error inesperado!</strong><br>
    ...
    if($ubicacion!=""){
    	if(verificar_datos("[a-zA-Z0-9·ÈÌÛ˙¡…Õ”⁄Ò— ]{5,150}",$ubicacion)){
	        echo '
	            <div class="notification is-danger is-light">
	                <strong>°Ocurrio un error inesperado!</strong><br>
    ...
    if($actualizar_categoria->execute($marcadores)){
        echo '
            <div class="notification is-info is-light">
                ...
                La categorÌa se actualizo con exito
            </div>
        ';
    }else{
        echo '
            <div class="notification is-danger is-light">
                <strong>°Ocurrio un error inesperado!</strong><br>
                No se pudo actualizar la categorÌa, por favor intente nuevamente
            </div>
        ';
    }
