<?php
    ...
    if(verificar_datos("[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò— ]{3,40}",$nombre)){
        echo '
            <div class="notification is-danger is-light">
                <strong>°Ocurrio un error inesperado!</strong><br>
    ...
    if(verificar_datos("[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò— ]{3,40}",$apellido)){
        echo '
            <div class="notification is-danger is-light">
                <strong>°Ocurrio un error inesperado!</strong><br>
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            if($check_email->rowCount()>0){
                echo '
                    <div class="notification is-danger is-light">
                        <strong>°Ocurrio un error inesperado!</strong><br>
                        El correo electrÛnico ingresado ya se encuentra registrado, por favor elija otro
                    </div>
                ';
                exit();
            }
            ...
            echo '
                <div class="notification is-danger is-light">
                    <strong>°Ocurrio un error inesperado!</strong><br>
                    Ha ingresado un correo electrÛnico no valido
                </div>
            ';
            exit();
        } 
